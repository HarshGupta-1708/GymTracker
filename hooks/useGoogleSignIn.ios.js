...
export function useGoogleSignIn() {
  ...
  useEffect(() => {
    // Configure native Google Sign-in on iOS
  ...
  const signIn = useCallback(async () => {
    try {
      ...
      // Ensure Google Play Services are available (safe to call on iOS, resolves immediately)
      ...
      console.error("iOS Native Google Sign-In Error:", err);
