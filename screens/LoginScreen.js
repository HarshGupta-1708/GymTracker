...
export default function LoginScreen({ onGuestLogin }) {
  ...
  const loginAsGuest = async () => {
    try {
      ...
      if (typeof onGuestLogin === "function") onGuestLogin();
      setGuestLoading(false);
    }
  };
      ...
      <View style={styles.content}>
        <View style={styles.branding}>
          <View style={styles.iconContainer}>
            <MaterialCommunityIcons name="dumbbell" size={60} color={C.accent} />
          </View>
        ...
        <View style={styles.loginSection}>
          ...
          <TouchableOpacity style={styles.guestButton} onPress={loginAsGuest} disabled={loading}>
        ...
        <Text style={styles.footer}>Powered by Firebase • Live Sync • Offline Ready</Text>
      </View>
    </View>
  );
}
